...
export const ContactSection = () => {
  return (
    <section id="contact" className="py-20 md:py-24 bg-background relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="w-11 h-11 bg-primary/10 rounded-xl flex items-center justify-center flex-shrink-0 border border-primary/20">
                <MapPin className="w-5 h-5 text-primary" />
              </div>
              <div>
                <h4 className="text-base font-bold mb-1 text-foreground">Location</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-base font-bold mb-1 text-foreground">Contact</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-base font-bold mb-1 text-foreground">Email</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="w-full">
                <h4 className="text-base font-bold mb-3 text-foreground">Hours</h4>
          ...
          {/* Map */}
          <div className="bg-card border border-border p-2 rounded-3xl min-h-[400px]">
            <iframe 
              src="https://maps.google.com/maps?q=28.758113,77.503955&t=&z=15&ie=UTF8&iwloc=&output=embed" 
              className="w-full h-full min-h-[380px] border-0 rounded-[1.25rem] dark:invert-[.9] dark:hue-rotate-180" 
