    ...
    <section id="testimonials" className="py-24 bg-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-heading font-bold mb-4">Trusted by Thousands</h3>
        ...
        <div className="flex overflow-x-auto pb-12 snap-x snap-mandatory hide-scrollbar gap-8">
          {testimonialsData.map((testimonial, idx) => (
            <div 
              key={idx} 
              className="flex-none w-[85vw] md:w-[400px] snap-center glass-card rounded-3xl p-8 hover:-translate-y-2 transition-transform duration-500"
            >
